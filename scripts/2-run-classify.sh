...
--label_csv $LABEL_DIR/mimic-findings-labels-$LABELER.csv \
--feature_h5 $OUTPUT_DIR/mimic-cxr-biovilt.h5 \
--output_results $OUTPUT_DIR/mimic-findings-biovilt-classifiers-$LABELER \
...
--output_results $OUTPUT_DIR/mimic-findings-resnet50-classifiers-$LABELER \
--num_workers $NUM_WORKERS
...
--split_csv $MIMIC_CXR_DIR/mimic-cxr-2.0.0-split.csv \
--metadata_csv $MIMIC_CXR_DIR/mimic-cxr-2.0.0-metadata.csv \
--label_csv $LABEL_DIR/mimic-impression-labels-$LABELER.csv \
--feature_h5 $OUTPUT_DIR/mimic-cxr-biovilt.h5 \
--output_results $OUTPUT_DIR/mimic-impression-biovilt-classifiers-$LABELER \
--num_workers $NUM_WORKERS
...
--feature_h5 $OUTPUT_DIR/mimic-cxr-resnet50.h5 \
--feature_key img_proj \
--output_results $OUTPUT_DIR/mimic-impression-resnet50-classifiers-$LABELER \
--num_workers $NUM_WORKERS
...
--label_csv $LABEL_DIR/chexpertplus-findings-labels-$LABELER.csv \
--feature_h5 $OUTPUT_DIR/chexpertplus-gloria.h5 \
--output_results $OUTPUT_DIR/chexpertplus-findings-gloria-classifiers-$LABELER \
--num_workers $NUM_WORKERS
...
--feature_key img_proj \
--output_results $OUTPUT_DIR/chexpertplus-findings-resnet50-classifiers-$LABELER \
--num_workers $NUM_WORKERS
...
--split_csv $CHEXPERTPLUS_DIR/split.csv \
--metadata_csv $CHEXPERTPLUS_DIR/metadata.csv \
--label_csv $LABEL_DIR/chexpertplus-impression-labels-$LABELER.csv \
--feature_h5 $OUTPUT_DIR/chexpertplus-gloria.h5 \
--output_results $OUTPUT_DIR/chexpertplus-impression-gloria-classifiers-$LABELER \
--num_workers $NUM_WORKERS
...
--feature_h5 $OUTPUT_DIR/chexpertplus-resnet50.h5 \
--feature_key img_proj \
--output_results $OUTPUT_DIR/chexpertplus-impression-resnet50-classifiers-$LABELER \
--num_workers $NUM_WORKERS
