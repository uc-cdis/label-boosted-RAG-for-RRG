...
--model_config $REPO_ROOT/configs/classify/svm-hyperparam.yaml \
--output_results $OUTPUT_DIR/mimic-findings-biovilt-svm-hyperparam \
...
--model_config $REPO_ROOT/configs/classify/svm-hyperparam.yaml \
--output_results $OUTPUT_DIR/mimic-findings-resnet50-svm-hyperparam \
--parallelize_labels 14
...
--feature_h5 $OUTPUT_DIR/mimic-cxr-biovilt.h5 \
--model_config $REPO_ROOT/configs/classify/svm-hyperparam.yaml \
--output_results $OUTPUT_DIR/mimic-impression-biovilt-svm-hyperparam \
--parallelize_labels 14
...
--feature_key img_proj \
--model_config $REPO_ROOT/configs/classify/svm-hyperparam.yaml \
--output_results $OUTPUT_DIR/mimic-impression-resnet50-svm-hyperparam \
--parallelize_labels 14
...
--model_config $REPO_ROOT/configs/classify/svm-hyperparam.yaml \
--output_results $OUTPUT_DIR/chexpertplus-findings-gloria-svm-hyperparam \
--parallelize_labels 14
...
--feature_key img_proj \
--model_config $REPO_ROOT/configs/classify/svm-hyperparam.yaml \
--output_results $OUTPUT_DIR/chexpertplus-findings-resnet50-svm-hyperparam \
--parallelize_labels 14
...
--feature_h5 $OUTPUT_DIR/chexpertplus-gloria.h5 \
--model_config $REPO_ROOT/configs/classify/svm-hyperparam.yaml \
--output_results $OUTPUT_DIR/chexpertplus-impression-gloria-svm-hyperparam \
--parallelize_labels 14
...
--feature_key img_proj \
--model_config $REPO_ROOT/configs/classify/svm-hyperparam.yaml \
--output_results $OUTPUT_DIR/chexpertplus-impression-resnet50-svm-hyperparam \
--parallelize_labels 14
