...
--model_config $REPO_ROOT/configs/classify/xgb-hyperparam.yaml \
--output_results $OUTPUT_DIR/mimic-findings-biovilt-xgb-hyperparam \
...
--model_config $REPO_ROOT/configs/classify/xgb-hyperparam.yaml \
--output_results $OUTPUT_DIR/mimic-findings-resnet50-xgb-hyperparam \
--parallelize_labels 14
...
--feature_h5 $OUTPUT_DIR/mimic-cxr-biovilt.h5 \
--model_config $REPO_ROOT/configs/classify/xgb-hyperparam.yaml \
--output_results $OUTPUT_DIR/mimic-impression-biovilt-xgb-hyperparam \
--parallelize_labels 14
...
--feature_key img_proj \
--model_config $REPO_ROOT/configs/classify/xgb-hyperparam.yaml \
--output_results $OUTPUT_DIR/mimic-impression-resnet50-xgb-hyperparam \
--parallelize_labels 14
...
--model_config $REPO_ROOT/configs/classify/xgb-hyperparam.yaml \
--output_results $OUTPUT_DIR/chexpertplus-findings-gloria-xgb-hyperparam \
--parallelize_labels 14
...
--feature_key img_proj \
--model_config $REPO_ROOT/configs/classify/xgb-hyperparam.yaml \
--output_results $OUTPUT_DIR/chexpertplus-findings-resnet50-xgb-hyperparam \
--parallelize_labels 14
...
--feature_h5 $OUTPUT_DIR/chexpertplus-gloria.h5 \
--model_config $REPO_ROOT/configs/classify/xgb-hyperparam.yaml \
--output_results $OUTPUT_DIR/chexpertplus-impression-gloria-xgb-hyperparam \
--parallelize_labels 14
...
--feature_key img_proj \
--model_config $REPO_ROOT/configs/classify/xgb-hyperparam.yaml \
--output_results $OUTPUT_DIR/chexpertplus-impression-resnet50-xgb-hyperparam \
--parallelize_labels 14
